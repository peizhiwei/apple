						...
						<div class="container-fluid">
							...
							<div class="navbar-header">
								...
								<a class="navbar-brand"><span
									class="glyphicon glyphicon-globe" aria-hidden="true"></span><b>出库管理</b></a>
							</div>
						</div>
					</nav>
					<div>
						...
						<div class="col-xs-6 text-right">
							<button type="button" class="btn btn-default"
								onclick="window.location.href='/apple/admini/Outstoredetails'">
					...
					<div class="container">
						<form class="form-inline">
							<div class="form-group">
								<label for="exampleInputName2">出库编号:</label> <input type="text"
		...
		var app = new Vue({
			...
			methods : {
				getoutstorelist : function(data) {
					//发送get请求
					this.$http.get(
							"http://localhost:8080/apple/admini/getoutstore?number="
