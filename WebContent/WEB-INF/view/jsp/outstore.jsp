                ...
                <div>
                    ...
                    <div class="container">
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                <label for="exampleInputName2">出库数量:</label>
                                <input type="text" class="form-control" id="newamount"
                                   v-model="newamount" name="newamount" placeholder="请输入出库数量">
                            </div>
                            <div class="form-group">
                                <input type="button" class="form-control" value="出库" @click="insertstore()">
                            </div>
                        </form>
                    </div>&nbsp;&nbsp;
                    <div class="container">
