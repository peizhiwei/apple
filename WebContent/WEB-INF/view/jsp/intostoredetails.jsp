            ...
            <div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand"><span class="glyphicon glyphicon-globe"
                                    aria-hidden="true"></span><b>入库详情</b></a>
                        </div>
                </nav>
                <div>
                    ...
                    <div class="col-xs-6 text-right">
                        <button type="button" class="btn btn-default" onclick="window.location.href='/apple/admini/IntoStore'"><span class="glyphicon glyphicon-remove-sign"
                ...
                <div class="container">
                    <form class="navbar-form navbar-left">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="搜索入库时间">
                            <span class="input-group-btn">
